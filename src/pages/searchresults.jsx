...
console.log(error)
  ...
  if(search.toLowerCase().split(" ").length > 0){
    ...
    query = query.where("searchKeywords", "array-contains-any", search.toLowerCase().split(" "))
query.get().then((querySnapshot) => {
  ...
  return (
    <div className="pt-[90px] lg:pt-[50px] bg-[#000000]">
