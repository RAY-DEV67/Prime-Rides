      ...
      <div className="mx-[1rem] text-left">
        ...
        <div className="mb-[1rem]">
          ...
          <p> {buyProduct?.description}</p>
              ...
              <a href={`https://wa.me/09016011178?text=I'm%20interested%20in%20this%20car%20for%20sale: ${window.location.pathname}`} target="_Blank" className="flex border-[#2099fe] border bg-[#2099fe] py-[0.2rem] lg:py-[0.8rem] lg:w-[20%] justify-center w-[40%] items-center">
