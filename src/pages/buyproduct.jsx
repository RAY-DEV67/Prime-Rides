...
console.log(window.location.pathname)
  ...
  return (
    <div className="lg:mt-[7rem] pt-[4rem] bg-[#333e51] text-white productfont">
      {/* <Topnav /> */}
     {buyProduct ? <div>
     <div className="flex justify-center relative mt-[2rem] mx-[0.5rem] lg:-z-10">
      ...
      <div className="mx-[1rem] text-left">
        ...
        <div className="mb-[1rem]">
          ...
          <p> {buyProduct?.description}</p>
              ...
              <a href={`https://wa.me/09016011178?text=I'm%20interested%20in%20this%20car%20for%20sale: ${window.location.pathname}`} target="_Blank" className="flex border-[#2099fe] border bg-[#2099fe] py-[0.2rem] justify-center w-[40%] items-center">
              ...
              <a href="https://www.instagram.com/optcars_01/?hl=en" target="_blank" className="flex border-[#2099fe] border bg-[#2099fe] py-[0.2rem] justify-center w-[40%] items-center">
      ...
      <h2 className="mt-[2rem] mb-[0.5rem] text-2xl ml-[1rem] font-bold text-white">Similar Products</h2>
