    ...
    <div className="relative">
      <div className="landing h-[100vh] relative">
        <div className="absolute top-[15%]">
          ...
          <p className="text-center text-2xl font-bold text-white w-[100vw] BodyFont">
            POWER YOUR
          </p>
          <p className="text-center text-5xl font-bold text-[#2099fe] w-[100vw] BodyFont">
            DREAM DRIVE
          </p>
        </div>
        <div className="flex flex-col items-center">
          <div className="absolute top-[70%] w-[80vw]">
            <Search />
          </div>
        </div>
      </div>
