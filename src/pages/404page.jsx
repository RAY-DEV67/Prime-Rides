...
export function Page404() {
    return ( <div className="flex text-white flex-col items-center lg:absolute lg:top-[13%] pt-[70px] lg:left-[35%] lg:z-[-1] lg:w-[60%]">
        ...
        <Link to="/">
        <button className="text-white rounded-[20px] bg-[#2099fe] font-bold mt-[2rem] py-[0.5rem] px-[1rem]">GO TO HOMEPAGE</button>
        </Link>
        </div>
    </div> );
}